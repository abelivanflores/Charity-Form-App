/* Creates an Event by giving user options to fillout 
uses v-model-select to show limited choices
date form-control to have use tool to input date from the bootstrap for vue library 
*/
<template>
